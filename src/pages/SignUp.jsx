...
export default function SignUp() {
  ...
  async function onSubmit(e){
    ...
    try {
      ...
      toast.error("Sign up was successful")
      navigate("/");
    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6 ">
          <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8a2V5fGVufDB8fDB8fHww&auto=format&fit=crop&w=700&q=60" 
          alt="key"
